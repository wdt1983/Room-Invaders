...
- [TODO] 8.0.1 — Art pass: replace ALL placeholder sprites with consistent final art. **Also folds in 1.0.19 (wall color picker) and 1.0.20 (floor type selector)**, which were deferred from Phase 1 pending real wall/floor sprites to customize.
